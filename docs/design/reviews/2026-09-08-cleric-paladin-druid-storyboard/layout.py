...
def page(number, title, subtitle, height):
    ...
    text(d, 44, 24, 'QUESTMANCER  /  BOOK, SHIELD & BRANCH STUDIES  /  ' + number, 15, GOLD)
...
im, d = page('01', 'A book, a shield, a living staff', 'Larger heads, shorter bodies, planted feet. Class gear carries the identity.', 1170)
notes = {
'cleric': ['White hood; blue and gold vestments.', 'A broad book beside the gem staff.', 'One finger traces the open page.'],
'paladin': ['Chestnut beard; broad silver armour.', 'A blue shield with a warm gold rim.', 'One hand checks its leather strap.'],
'druid': ['Leaf-green hood; small branch antlers.', 'A living staff and a soft white beard.', 'A hand gently bends the leafy sprig.']}
...
text(d,44,948,'Spoils are a sealed book, wrapped shield or seed pouch: a completion metaphor, never verified contents.',18,MUTED)
...
text(d,44,985,'Cleric working · Paladin seeking counsel · Druid resting. No live Herdr or native-terminal acceptance claimed.',17,MUTED)
