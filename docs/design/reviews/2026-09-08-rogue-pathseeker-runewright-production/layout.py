...
def page(number, title, subtitle, height):
    ...
    text(d,(48,28),'QUESTMANCER  /  LOCK, COMPASS & RUNE PRODUCTION  /  '+number,15,GOLD,'mono')
...
text(d,(48,1224),'Lock / compass / rune stone remain class-specific. The shared raised signal settles into a calm blocked pose.',18)
...
im,d=page('03','A brief gesture, then a quiet room','Production room crops: Rogue, Pathseeker and Runewright in separate fixtures, each at its real station.',1930)
