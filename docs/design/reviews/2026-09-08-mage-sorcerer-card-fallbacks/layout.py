...
NAMES=['Mage','Sorcerer']
im,d=page('01','The same adventurer on the card','The new personalised world sprites replace the final two long-bodied card fallbacks. Native pixels; no stretching.',920)
...
im,d=page('02','Stocky sprites, readable cards','Production Ratatui card buffers. Text reconstructed in Menlo; these are fixtures, not terminal screenshots.',1250)
...
text(d,(48,1125),'Existing card bounds, text and actions remain in place. The new fallback is a static class portrait.',19)
text(d,(48,1156),'All fourteen classes now match their world sprites. The revised Librarian retains its independent fallback.',18,MUTED)
