...
def page(number, title, subtitle, height):
    ...
    text(d,(48,28),'QUESTMANCER  /  TOOL RITUAL PRODUCTION  /  '+number,15,GOLD,'mono')
...
NAMES=['Bard','Artificer','Testmender']
...
text(d,(48,1002),'Persona variation and retained roster partners',25,GOLD,'serif')
...
text(d,(48,1224),'Lute / device / needlework remain class-specific. The shared raised signal settles into a calm blocked pose.',18)
...
im,d=page('03','A brief gesture, then a quiet room','Production room crops: Bard, Artificer and Testmender in separate fixtures, each at its real station.',1930)
