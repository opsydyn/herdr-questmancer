...
def page(number, title, subtitle, height):
    ...
    text(d, 44, 24, 'QUESTMANCER  /  TOOL RITUAL STUDIES  /  ' + number, 15, GOLD)
...
im, d = page('01', 'A lute, a little machine, a mending kit', 'Larger heads, shorter bodies, planted feet. Class gear carries the identity.', 1170)
notes = {
'bard': ['Plum cap and feather; chestnut curls.', 'A rounded lute with a visible neck.', 'The picking hand crosses its strings.'],
'artificer': ['Forehead goggles; short indigo coat.', 'A brass device cradled in both hands.', 'A small turn changes the gear cluster.'],
 'testmender': ['Soft linen cap; a red mending badge.', 'A pale patch and a bright steel needle.', 'The needle draws into the patch.']}
...
text(d,44,948,'Spoils are a sealed folio, wrapped device or folded patch: a completion metaphor, never verified contents.',18,MUTED)
...
text(d,44,985,'Bard working · Artificer seeking counsel · Testmender resting. No live Herdr or native-terminal acceptance claimed.',17,MUTED)
