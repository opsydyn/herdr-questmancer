...
through Ghostty and Herdr 0.7.4 using Kitty graphics. Bard, Paladin and Orc
...
5. Select a Barbarian, Bard, Paladin, Rogue, Wizard, Goblin or Orc adventurer with an embedded
   portrait.
