...
through Ghostty and Herdr 0.7.4 using Kitty graphics. Artificer, Bard, Cleric, Druid, Paladin and Orc
...
5. Select an Artificer, Barbarian, Bard, Cleric, Druid, Paladin, Rogue, Wizard, Goblin or Orc adventurer with an embedded
   portrait.
