...
through Ghostty and Herdr 0.7.4 using Kitty graphics. Bard and Paladin are
registered with the same transparent PNG contract and automated coverage; their
live native render remains a manual-review item. The world remains rendered by
...
5. Select a Barbarian, Bard, Paladin, Rogue, Wizard or Goblin adventurer with an embedded
   portrait.
