...
It contains twenty-three fixed production stories, each owned exactly once:
...
- native Artificer, Barbarian, Bard, Cleric, Druid, Paladin, Rogue, Wizard, Goblin and Orc card portraits with authored-sprite fallbacks
