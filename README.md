...
It contains twenty-four fixed production stories, each owned exactly once:
...
- native Artificer, Barbarian, Bard, Cleric, Druid, Paladin, Ranger, Rogue, Wizard, Goblin and Orc card portraits with authored-sprite fallbacks
