...
It contains nineteen fixed production stories, each owned exactly once:
...
- native Barbarian, Bard, Paladin, Rogue, Wizard and Goblin card portraits with authored-sprite fallbacks
