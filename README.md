...
It contains twenty fixed production stories, each owned exactly once:
...
- native Barbarian, Bard, Paladin, Rogue, Wizard, Goblin and Orc card portraits with authored-sprite fallbacks
