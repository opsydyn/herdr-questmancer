...
It contains twenty-one fixed production stories, each owned exactly once:
...
- native Barbarian, Bard, Druid, Paladin, Rogue, Wizard, Goblin and Orc card portraits with authored-sprite fallbacks
