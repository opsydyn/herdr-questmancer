...
For the current class-art review, inspect **Sprite Scout & Shadow World**, then
**Sprite Scout & Shadow Masters**, followed by **Sprite Grovekeeper World** and
**Sprite Grovekeeper Masters**. They show Bard, Ranger, Rogue and Druid at
their authored 16x24 world size and beside separate 24x32 portrait masters.
This is a review-only asset lane: it does not prompt agents, call Herdr, write
state, or replace the existing production sprites.
