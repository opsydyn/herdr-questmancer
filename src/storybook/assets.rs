...
storybook_asset_enum!(SceneFirstAsset {
    ...
    SpriteMaterialGoblin,
    SpriteMaterialWizard,
    SpriteMaterialBarbarian,
    SpritePortraitGoblin,
    SpritePortraitWizard,
    SpritePortraitBarbarian,
    SpriteMaterialBard,
    SpriteMaterialRanger,
    SpriteMaterialRogue,
    SpritePortraitBard,
    ...
    pub const fn label(self) -> &'static str {
        match self {
            Self::Class(value) => match value {
                ...
                AdventurerClass::Druid => "class: druid",
            ...
            Self::Gear(value) => match value {
                ...
                AdventuringGear::LivingStaff => "gear: living staff",
            ...
            Self::SceneFirst(value) => match value {
                ...
                SceneFirstAsset::SpriteMaterialGoblin => "Goblin material pass",
                SceneFirstAsset::SpriteMaterialWizard => "Wizard material pass",
                SceneFirstAsset::SpriteMaterialBarbarian => "Barbarian material pass",
                SceneFirstAsset::SpritePortraitGoblin => "Goblin portrait master",
                SceneFirstAsset::SpritePortraitWizard => "Wizard portrait master",
                SceneFirstAsset::SpritePortraitBarbarian => "Barbarian portrait master",
                SceneFirstAsset::SpriteMaterialBard => "Bard world sprite",
                SceneFirstAsset::SpriteMaterialRanger => "Ranger world sprite",
                SceneFirstAsset::SpriteMaterialRogue => "Rogue world sprite",
