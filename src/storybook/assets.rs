...
impl SceneFirstAsset {
    pub const ALL: &'static [Self] = &[
        ...
        Self::BarbarianPoseFamily,
        Self::WizardPoseFamily,
        Self::RangerPoseFamily,
        ...
        Self::NativeMagePortrait,
        Self::NativeSorcererPortrait,
    ...
    pub const fn label(self) -> &'static str {
        match self {
            ...
            Self::BarbarianPoseFamily => "asset: Barbarian pose family",
            Self::WizardPoseFamily => "asset: Wizard pose family",
            Self::RangerPoseFamily => "asset: Ranger pose family",
            ...
            Self::NativeMagePortrait => "asset: native Mage card portrait",
            Self::NativeSorcererPortrait => "asset: native Sorcerer card portrait",
