...
const fn ansi16(role: ColorRole) -> Color {
    match role {
        ColorRole::Stone | ColorRole::Steel => Color::Gray,
        ColorRole::DarkStone => Color::Black,
        ColorRole::Timber | ColorRole::Leather => Color::Red,
        ColorRole::Parchment | ColorRole::SkinLight => Color::LightYellow,
        ColorRole::Ink | ColorRole::HairDark => Color::DarkGray,
        ColorRole::Hearth | ColorRole::ClothWarm => Color::LightRed,
        ColorRole::Moss => Color::Green,
        ColorRole::RuneGlow => Color::LightCyan,
        ColorRole::Counsel | ColorRole::SkinMedium => Color::Yellow,
        ColorRole::Spoils => Color::LightMagenta,
        ColorRole::Selection | ColorRole::HairLight => Color::White,
